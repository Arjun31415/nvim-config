...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-swap', 'which-key.nvim', 'hop.nvim', 'lualine.nvim', 'targets.vim', 'neoscroll.nvim', 'unicode.vim', 'vim-commentary', 'AutoSave.nvim', 'vim-asterisk', 'alpha-nvim', 'vim-highlighturl', 'vim-indent-object', 'nvim-web-devicons', 'open-browser.vim', 'vim-matchup', 'indent-blankline.nvim', 'bufferline.nvim', 'whitespace.nvim', 'vim-repeat', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'gh.nvim', 'better-escape.vim', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'hlargs.nvim', 'spotify.nvim', 'nvim-cmp', 'trouble.nvim', 'nvim-autopairs', 'nvim-colorizer.lua', 'blamer.nvim', 'nvim-notify', 'instant.nvim', 'cmp-nvim-lsp', 'cmp-cmdline', 'presence.nvim', 'cmp-nvim-ultisnips', 'nvim-ts-rainbow', 'cmp-path', 'cmp-buffer', 'cmp-tabnine'}, { event = "BufEnter *" }, _G.packer_plugins)]]
