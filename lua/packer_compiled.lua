...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'lualine.nvim', 'vim-highlighturl', 'neoscroll.nvim', 'vim-indent-object', 'vim-matchup', 'AutoSave.nvim', 'alpha-nvim', 'vim-repeat', 'bufferline.nvim', 'vim-swap', 'open-browser.vim', 'which-key.nvim', 'targets.vim', 'vim-sandwich', 'hop.nvim', 'whitespace.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-kitty', 'nvim-autopairs', 'nvim-notify', 'blamer.nvim', 'nvim-ts-rainbow', 'vim-signify', 'cmp-cmdline', 'vimtex', 'cmp-nvim-lsp', 'refactoring.nvim', 'presence.nvim', 'nvim-colorizer.lua', 'cmp-path', 'hlargs.nvim', 'cmp-tabnine', 'renamer.nvim', 'spotify.nvim', 'cmp-buffer', 'instant.nvim', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
