...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "copilot-cmp", "cmp-path", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-tabnine" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-matchup', 'hop.nvim', 'vim-swap', 'open-browser.vim', 'indent-blankline.nvim', 'which-key.nvim', 'whitespace.nvim', 'lualine.nvim', 'AutoSave.nvim', 'alpha-nvim', 'neoscroll.nvim', 'bufferline.nvim', 'vim-sandwich', 'vim-asterisk', 'vim-commentary', 'vim-repeat', 'targets.vim', 'vim-highlighturl', 'unicode.vim', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-kitty', 'nvim-notify', 'vim-signify', 'hlargs.nvim', 'instant.nvim', 'refactoring.nvim', 'nvim-colorizer.lua', 'nvim-ts-rainbow', 'renamer.nvim', 'cmp-path', 'trouble.nvim', 'blamer.nvim', 'cmp-buffer', 'nvim-autopairs', 'cmp-cmdline', 'presence.nvim', 'cmp-nvim-lsp', 'vimtex', 'cmp-tabnine', 'spotify.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
