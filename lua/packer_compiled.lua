...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'nvim-ts-rainbow', 'BuildTask.nvim', 'blamer.nvim', 'hlargs.nvim', 'nvim-notify', 'instant.nvim', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'targets.vim', 'AutoSave.nvim', 'vim-asterisk', 'hop.nvim', 'vim-indent-object', 'indent-blankline.nvim', 'lspkind-nvim', 'vim-matchup', 'nvim-web-devicons', 'lualine.nvim', 'alpha-nvim', 'bufferline.nvim', 'neoscroll.nvim', 'vim-commentary', 'unicode.vim', 'vim-repeat', 'vim-sandwich', 'open-browser.vim', 'vim-highlighturl'}, { event = "VimEnter *" }, _G.packer_plugins)]]
