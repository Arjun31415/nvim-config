...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'BuildTask.nvim', 'hlargs.nvim', 'instant.nvim', 'nvim-notify', 'blamer.nvim', 'nvim-treesitter'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'open-browser.vim', 'vim-sandwich', 'targets.vim', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'unicode.vim', 'AutoSave.nvim', 'vim-asterisk', 'vim-commentary', 'bufferline.nvim', 'alpha-nvim', 'vim-highlighturl', 'indent-blankline.nvim', 'vim-matchup', 'neoscroll.nvim', 'vim-repeat', 'vim-indent-object', 'lualine.nvim', 'hop.nvim', 'nvim-web-devicons', 'lspkind-nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
