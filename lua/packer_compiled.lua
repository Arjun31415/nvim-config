...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-cmp', 'vim-signify', 'nvim-autopairs', 'nvim-notify', 'blamer.nvim', 'cmp-cmdline', 'presence.nvim', 'cmp-nvim-lsp', 'spotify.nvim', 'cmp-nvim-ultisnips', 'nvim-colorizer.lua', 'cmp-path', 'cmp-tabnine', 'hlargs.nvim', 'trouble.nvim', 'cmp-buffer', 'nvim-ts-rainbow', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-highlighturl', 'vim-indent-object', 'vim-swap', 'vim-matchup', 'neoscroll.nvim', 'vim-repeat', 'alpha-nvim', 'AutoSave.nvim', 'bufferline.nvim', 'open-browser.vim', 'which-key.nvim', 'whitespace.nvim', 'hop.nvim', 'vim-asterisk', 'vim-sandwich', 'lualine.nvim', 'unicode.vim', 'nvim-web-devicons', 'vim-commentary', 'targets.vim', 'indent-blankline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
