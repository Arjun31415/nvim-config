...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'ultisnips', 'gh.nvim', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-notify', 'cmp-nvim-lsp', 'presence.nvim', 'cmp-path', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'trouble.nvim', 'nvim-ts-rainbow', 'nvim-autopairs', 'hlargs.nvim', 'instant.nvim', 'cmp-buffer', 'cmp-tabnine', 'vim-signify', 'cmp-cmdline', 'vimtex', 'blamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'AutoSave.nvim', 'alpha-nvim', 'vim-asterisk', 'nvim-web-devicons', 'open-browser.vim', 'vim-indent-object', 'vim-highlighturl', 'hop.nvim', 'vim-matchup', 'indent-blankline.nvim', 'vim-swap', 'lualine.nvim', 'vim-repeat', 'vim-sandwich', 'vim-commentary', 'targets.vim', 'neoscroll.nvim', 'whitespace.nvim', 'bufferline.nvim', 'which-key.nvim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
