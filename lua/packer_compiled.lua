...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'lspkind-nvim', 'lualine.nvim', 'neoscroll.nvim', 'vim-indent-object', 'nvim-web-devicons', 'open-browser.vim', 'vim-matchup', 'AutoSave.nvim', 'targets.vim', 'alpha-nvim', 'vim-repeat', 'vim-sandwich', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'vim-swap', 'which-key.nvim', 'bufferline.nvim', 'whitespace.nvim', 'vim-highlighturl', 'hop.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'instant.nvim', 'nvim-colorizer.lua', 'nvim-notify', 'nvim-treesitter', 'nvim-ts-rainbow', 'BuildTask.nvim', 'vim-signify', 'blamer.nvim', 'hlargs.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
