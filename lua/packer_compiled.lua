...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp-nvim-ultisnips", "copilot-cmp" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-symbols.nvim", "telescope-ui-select.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-markdown', 'vim-markdownfootnotes', 'vim-json'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'alpha-nvim', 'auto-save.nvim', 'targets.vim', 'vim-swap', 'unicode.vim', 'lualine.nvim', 'open-browser.vim', 'vim-highlighturl', 'vim-sandwich', 'vim-indent-object', 'indent-blankline.nvim', 'neoscroll.nvim', 'bufferline.nvim', 'vim-matchup', 'nvim-dap', 'vim-hexokinase', 'vim-repeat', 'whitespace.nvim', 'hop.nvim', 'which-key.nvim', 'kommentary', 'vim-asterisk'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'cmp-buffer', 'vim-signify', 'cmp-cmdline', 'cmp-nvim-lsp', 'vimtex', 'trouble.nvim', 'cmp-path', 'cmp-tabnine', 'instant.nvim', 'hlargs.nvim', 'blamer.nvim', 'vim-kitty', 'nvim-notify', 'nvim-ts-rainbow', 'nvim-autopairs'}, { event = "BufEnter *" }, _G.packer_plugins)]]
