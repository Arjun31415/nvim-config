...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'whitespace.nvim', 'alpha-nvim', 'vim-asterisk', 'lualine.nvim', 'bufferline.nvim', 'neoscroll.nvim', 'vim-hexokinase', 'vim-highlighturl', 'hop.nvim', 'vim-indent-object', 'indent-blankline.nvim', 'open-browser.vim', 'kommentary', 'nvim-dap', 'auto-save.nvim', 'vim-repeat', 'vim-sandwich', 'targets.vim', 'vim-swap', 'unicode.vim', 'vim-matchup', 'which-key.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-path', 'nvim-autopairs', 'cmp-tabnine', 'hlargs.nvim', 'nvim-ts-rainbow', 'vim-kitty', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'nvim-notify', 'spotify.nvim', 'vim-signify', 'vimtex', 'instant.nvim', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
