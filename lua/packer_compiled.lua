...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lspkind-nvim', 'whitespace.nvim', 'neoscroll.nvim', 'targets.vim', 'nvim-web-devicons', 'unicode.vim', 'open-browser.vim', 'vim-asterisk', 'vim-commentary', 'AutoSave.nvim', 'vim-highlighturl', 'vim-indent-object', 'alpha-nvim', 'bufferline.nvim', 'vim-matchup', 'vim-repeat', 'vim-sandwich', 'hop.nvim', 'lualine.nvim', 'indent-blankline.nvim', 'vim-swap', 'which-key.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-notify', 'BuildTask.nvim', 'blamer.nvim', 'hlargs.nvim', 'nvim-ts-rainbow', 'vim-signify', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
