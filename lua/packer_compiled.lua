...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'nvim-notify', 'hlargs.nvim', 'instant.nvim', 'nvim-colorizer.lua', 'nvim-ts-rainbow', 'BuildTask.nvim', 'vim-signify'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'bufferline.nvim', 'open-browser.vim', 'indent-blankline.nvim', 'lspkind-nvim', 'targets.vim', 'lualine.nvim', 'neoscroll.nvim', 'vim-matchup', 'vim-asterisk', 'vim-repeat', 'vim-commentary', 'vim-swap', 'which-key.nvim', 'hop.nvim', 'AutoSave.nvim', 'whitespace.nvim', 'vim-highlighturl', 'unicode.vim', 'vim-indent-object', 'vim-sandwich', 'alpha-nvim', 'nvim-web-devicons'}, { event = "VimEnter *" }, _G.packer_plugins)]]
