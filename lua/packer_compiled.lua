...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'vim-matchup', 'nvim-web-devicons', 'open-browser.vim', 'vim-repeat', 'targets.vim', 'vim-sandwich', 'alpha-nvim', 'vim-swap', 'unicode.vim', 'which-key.nvim', 'vim-asterisk', 'vim-commentary', 'hop.nvim', 'indent-blankline.nvim', 'whitespace.nvim', 'bufferline.nvim', 'lspkind-nvim', 'AutoSave.nvim', 'lualine.nvim', 'vim-highlighturl', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-notify', 'nvim-ts-rainbow', 'BuildTask.nvim', 'blamer.nvim', 'hlargs.nvim', 'instant.nvim', 'vim-signify'}, { event = "BufEnter *" }, _G.packer_plugins)]]
