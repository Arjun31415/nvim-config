...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'indent-blankline.nvim', 'vim-repeat', 'vim-sandwich', 'vim-swap', 'neoscroll.nvim', 'which-key.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'open-browser.vim', 'hop.nvim', 'lualine.nvim', 'AutoSave.nvim', 'alpha-nvim', 'targets.vim', 'bufferline.nvim', 'unicode.vim', 'vim-asterisk', 'vim-commentary'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-ts-rainbow', 'spotify.nvim', 'presence.nvim', 'instant.nvim', 'nvim-colorizer.lua', 'cmp-nvim-ultisnips', 'cmp-nvim-lsp', 'cmp-buffer', 'trouble.nvim', 'blamer.nvim', 'nvim-autopairs', 'cmp-cmdline', 'nvim-notify', 'vim-signify', 'cmp-path', 'cmp-tabnine', 'hlargs.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
