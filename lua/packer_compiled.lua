...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'alpha-nvim', 'vim-swap', 'nvim-web-devicons', 'which-key.nvim', 'open-browser.vim', 'whitespace.nvim', 'targets.vim', 'hop.nvim', 'indent-blankline.nvim', 'vim-commentary', 'neoscroll.nvim', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'vim-asterisk', 'lualine.nvim', 'vim-repeat', 'AutoSave.nvim', 'vim-sandwich', 'lspkind-nvim', 'unicode.vim', 'bufferline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-ts-rainbow', 'blamer.nvim', 'hlargs.nvim', 'instant.nvim', 'nvim-colorizer.lua', 'vim-signify', 'nvim-notify', 'BuildTask.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
