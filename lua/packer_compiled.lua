...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-tabnine", "copilot-cmp", "cmp-path" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'bufferline.nvim', 'vim-asterisk', 'vim-commentary', 'lualine.nvim', 'vim-highlighturl', 'hop.nvim', 'vim-indent-object', 'indent-blankline.nvim', 'neoscroll.nvim', 'vim-matchup', 'vim-repeat', 'vim-sandwich', 'targets.vim', 'vim-swap', 'AutoSave.nvim', 'nvim-web-devicons', 'which-key.nvim', 'open-browser.vim', 'whitespace.nvim', 'alpha-nvim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp', 'trouble.nvim', 'cmp-tabnine', 'hlargs.nvim', 'instant.nvim', 'nvim-autopairs', 'nvim-colorizer.lua', 'presence.nvim', 'vim-signify', 'nvim-notify', 'nvim-ts-rainbow', 'vimtex', 'cmp-path', 'spotify.nvim', 'blamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'copilot.lua', 'better-escape.vim', 'gh.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
