...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'better-escape.vim', 'copilot.lua', 'gh.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'instant.nvim', 'vim-signify', 'blamer.nvim', 'cmp-buffer', 'nvim-autopairs', 'cmp-nvim-lsp', 'nvim-colorizer.lua', 'cmp-nvim-ultisnips', 'cmp-path', 'cmp-tabnine', 'nvim-ts-rainbow', 'presence.nvim', 'spotify.nvim', 'nvim-notify', 'cmp-cmdline', 'trouble.nvim', 'hlargs.nvim', 'nvim-cmp'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-commentary', 'vim-repeat', 'indent-blankline.nvim', 'vim-sandwich', 'AutoSave.nvim', 'vim-swap', 'vim-indent-object', 'lualine.nvim', 'alpha-nvim', 'whitespace.nvim', 'neoscroll.nvim', 'bufferline.nvim', 'nvim-web-devicons', 'open-browser.vim', 'targets.vim', 'which-key.nvim', 'vim-highlighturl', 'vim-asterisk', 'vim-matchup', 'hop.nvim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
