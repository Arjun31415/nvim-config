...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-tabnine", "cmp-nvim-ultisnips", "cmp-path", "copilot-cmp" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-dap', 'hop.nvim', 'vim-hexokinase', 'indent-blankline.nvim', 'vim-highlighturl', 'vim-indent-object', 'kommentary', 'open-browser.vim', 'lualine.nvim', 'vim-matchup', 'vim-repeat', 'vim-sandwich', 'vim-swap', 'which-key.nvim', 'auto-save.nvim', 'alpha-nvim', 'whitespace.nvim', 'bufferline.nvim', 'vim-asterisk', 'targets.vim', 'neoscroll.nvim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'nvim-notify', 'nvim-ts-rainbow', 'instant.nvim', 'vim-kitty', 'vim-signify', 'vimtex', 'renamer.nvim', 'blamer.nvim', 'presence.nvim', 'spotify.nvim', 'cmp-buffer', 'cmp-cmdline', 'refactoring.nvim', 'cmp-nvim-lsp', 'cmp-tabnine', 'cmp-path', 'trouble.nvim', 'nvim-autopairs'}, { event = "BufEnter *" }, _G.packer_plugins)]]
