...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "copilot-cmp", "cmp-buffer", "cmp-tabnine", "cmp-cmdline" },
...
vim.api.nvim_set_keymap("n", "*", "<cmd>lua require('packer.load')({'nvim-hlslens'}, { keys = '*', prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "#", "<cmd>lua require('packer.load')({'nvim-hlslens'}, { keys = '#', prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "n", "<cmd>lua require('packer.load')({'nvim-hlslens'}, { keys = 'n', prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "N", "<cmd>lua require('packer.load')({'nvim-hlslens'}, { keys = 'N', prefix = '' }, _G.packer_plugins)<cr>", { noremap = true, silent = true })
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-kitty', 'nvim-notify', 'nvim-ts-rainbow', 'vim-signify', 'cmp-nvim-lsp', 'cmp-path', 'presence.nvim', 'refactoring.nvim', 'cmp-buffer', 'renamer.nvim', 'spotify.nvim', 'hlargs.nvim', 'vimtex', 'instant.nvim', 'trouble.nvim', 'blamer.nvim', 'cmp-tabnine', 'cmp-cmdline', 'nvim-autopairs'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'better-escape.vim', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-indent-object', 'vim-matchup', 'vim-sandwich', 'open-browser.vim', 'which-key.nvim', 'whitespace.nvim', 'nvim-dap', 'lualine.nvim', 'vim-asterisk', 'vim-swap', 'kommentary', 'targets.vim', 'indent-blankline.nvim', 'unicode.vim', 'alpha-nvim', 'neoscroll.nvim', 'vim-repeat', 'auto-save.nvim', 'bufferline.nvim', 'vim-hexokinase', 'hop.nvim', 'vim-highlighturl'}, { event = "VimEnter *" }, _G.packer_plugins)]]
