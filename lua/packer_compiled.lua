...
_G.packer_plugins = {
  ...
  ["trouble.nvim"] = {
    loaded = true,
    path = "/home/arjun/.local/share/nvim/site/pack/packer/start/trouble.nvim",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-repeat', 'targets.vim', 'vim-swap', 'whitespace.nvim', 'vim-highlighturl', 'vim-commentary', 'vim-indent-object', 'indent-blankline.nvim', 'lualine.nvim', 'AutoSave.nvim', 'alpha-nvim', 'neoscroll.nvim', 'open-browser.vim', 'vim-matchup', 'which-key.nvim', 'vim-asterisk', 'vim-sandwich', 'hop.nvim', 'nvim-web-devicons', 'bufferline.nvim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-nvim-lsp', 'spotify.nvim', 'cmp-path', 'cmp-tabnine', 'vim-signify', 'gh.nvim', 'nvim-cmp', 'instant.nvim', 'blamer.nvim', 'nvim-autopairs', 'nvim-colorizer.lua', 'nvim-notify', 'cmp-nvim-ultisnips', 'hlargs.nvim', 'nvim-ts-rainbow', 'cmp-buffer', 'cmp-cmdline'}, { event = "BufEnter *" }, _G.packer_plugins)]]
