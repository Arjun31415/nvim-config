...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "copilot-cmp", "cmp-buffer" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-symbols.nvim", "telescope-fzf-native.nvim" },
    commands = { "Telescope" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'markdown-preview.nvim', 'vim-markdownfootnotes', 'vim-json'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-cmdline', 'cmp-nvim-lsp', 'vim-kitty', 'nvim-autopairs', 'cmp-path', 'renamer.nvim', 'cmp-tabnine', 'blamer.nvim', 'nvim-notify', 'hlargs.nvim', 'nvim-ts-rainbow', 'instant.nvim', 'presence.nvim', 'trouble.nvim', 'refactoring.nvim', 'vim-signify', 'spotify.nvim', 'vimtex', 'cmp-buffer'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'better-escape.vim', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'lualine.nvim', 'neoscroll.nvim', 'nvim-dap', 'alpha-nvim', 'vim-matchup', 'vim-asterisk', 'hop.nvim', 'open-browser.vim', 'indent-blankline.nvim', 'unicode.vim', 'kommentary', 'vim-repeat', 'vim-swap', 'auto-save.nvim', 'targets.vim', 'which-key.nvim', 'vim-sandwich', 'whitespace.nvim', 'bufferline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
