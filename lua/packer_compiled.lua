...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'bufferline.nvim', 'hop.nvim', 'indent-blankline.nvim', 'lspkind-nvim', 'lualine.nvim', 'neoscroll.nvim', 'targets.vim', 'nvim-web-devicons', 'vim-matchup', 'unicode.vim', 'vim-repeat', 'vim-asterisk', 'vim-sandwich', 'whitespace.nvim', 'vim-swap', 'AutoSave.nvim', 'vim-highlighturl', 'which-key.nvim', 'vim-indent-object', 'alpha-nvim', 'vim-commentary', 'open-browser.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'hlargs.nvim', 'nvim-notify', 'nvim-treesitter', 'vim-signify', 'BuildTask.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
