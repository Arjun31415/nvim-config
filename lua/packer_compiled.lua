...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'unicode.vim', 'vim-asterisk', 'vim-commentary', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'lualine.nvim', 'vim-sandwich', 'alpha-nvim', 'neoscroll.nvim', 'vim-swap', 'vim-repeat', 'which-key.nvim', 'AutoSave.nvim', 'nvim-web-devicons', 'whitespace.nvim', 'open-browser.vim', 'hop.nvim', 'indent-blankline.nvim', 'bufferline.nvim', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-buffer', 'trouble.nvim', 'blamer.nvim', 'cmp-cmdline', 'hlargs.nvim', 'cmp-path', 'nvim-colorizer.lua', 'cmp-nvim-lsp', 'vim-signify', 'nvim-notify', 'nvim-ts-rainbow', 'vimtex', 'presence.nvim', 'nvim-autopairs', 'spotify.nvim', 'instant.nvim', 'cmp-tabnine'}, { event = "BufEnter *" }, _G.packer_plugins)]]
