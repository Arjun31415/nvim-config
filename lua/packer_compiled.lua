...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-cmdline', 'hlargs.nvim', 'cmp-nvim-lsp', 'cmp-nvim-ultisnips', 'instant.nvim', 'nvim-autopairs', 'nvim-colorizer.lua', 'blamer.nvim', 'nvim-notify', 'nvim-ts-rainbow', 'cmp-path', 'spotify.nvim', 'vim-signify', 'nvim-cmp', 'cmp-tabnine'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'bufferline.nvim', 'vim-asterisk', 'vim-commentary', 'hop.nvim', 'indent-blankline.nvim', 'vim-highlighturl', 'vim-indent-object', 'lualine.nvim', 'vim-matchup', 'AutoSave.nvim', 'vim-repeat', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'open-browser.vim', 'vim-sandwich', 'targets.vim', 'alpha-nvim', 'unicode.vim', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
