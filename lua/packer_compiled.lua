...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-tabnine', 'nvim-ts-rainbow', 'presence.nvim', 'spotify.nvim', 'hlargs.nvim', 'instant.nvim', 'nvim-cmp', 'nvim-autopairs', 'vim-signify', 'blamer.nvim', 'trouble.nvim', 'cmp-buffer', 'cmp-cmdline', 'nvim-colorizer.lua', 'cmp-nvim-lsp', 'nvim-notify', 'cmp-nvim-ultisnips'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'open-browser.vim', 'targets.vim', 'hop.nvim', 'indent-blankline.nvim', 'unicode.vim', 'lualine.nvim', 'vim-asterisk', 'vim-commentary', 'neoscroll.nvim', 'vim-highlighturl', 'vim-indent-object', 'AutoSave.nvim', 'vim-matchup', 'vim-sandwich', 'alpha-nvim', 'bufferline.nvim', 'vim-repeat', 'vim-swap'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'gh.nvim', 'better-escape.vim', 'copilot.lua', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
