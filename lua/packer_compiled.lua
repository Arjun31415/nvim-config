...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'nvim-notify', 'blamer.nvim', 'hlargs.nvim', 'BuildTask.nvim', 'nvim-treesitter'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-repeat', 'vim-sandwich', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'targets.vim', 'AutoSave.nvim', 'alpha-nvim', 'vim-asterisk', 'open-browser.vim', 'vim-highlighturl', 'vim-indent-object', 'hop.nvim', 'vim-matchup', 'indent-blankline.nvim', 'lspkind-nvim', 'lualine.nvim', 'neoscroll.nvim', 'vim-commentary', 'bufferline.nvim', 'unicode.vim', 'nvim-web-devicons'}, { event = "VimEnter *" }, _G.packer_plugins)]]
