...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'better-escape.vim', 'ultisnips', 'delimitMate'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'instant.nvim', 'nvim-colorizer.lua', 'vim-signify', 'nvim-notify', 'nvim-ts-rainbow', 'blamer.nvim', 'BuildTask.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'vim-highlighturl', 'indent-blankline.nvim', 'vim-indent-object', 'lspkind-nvim', 'lualine.nvim', 'vim-matchup', 'neoscroll.nvim', 'vim-repeat', 'vim-sandwich', 'vim-swap', 'AutoSave.nvim', 'which-key.nvim', 'nvim-cmp', 'alpha-nvim', 'open-browser.vim', 'bufferline.nvim', 'targets.vim', 'cmp-tabnine', 'whitespace.nvim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'nvim-web-devicons'}, { event = "VimEnter *" }, _G.packer_plugins)]]
