...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-matchup', 'neoscroll.nvim', 'vim-repeat', 'AutoSave.nvim', 'vim-sandwich', 'vim-swap', 'nvim-web-devicons', 'which-key.nvim', 'open-browser.vim', 'targets.vim', 'alpha-nvim', 'bufferline.nvim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'hop.nvim', 'indent-blankline.nvim', 'vim-highlighturl', 'vim-indent-object', 'whitespace.nvim', 'lspkind-nvim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-notify', 'vim-signify', 'nvim-ts-rainbow', 'BuildTask.nvim', 'blamer.nvim', 'hlargs.nvim', 'instant.nvim', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
