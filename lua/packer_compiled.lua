...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "copilot-cmp", "cmp-nvim-ultisnips" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdownfootnotes', 'markdown-preview.nvim', 'vim-json', 'vim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'bufferline.nvim', 'which-key.nvim', 'whitespace.nvim', 'targets.vim', 'unicode.vim', 'hop.nvim', 'vim-asterisk', 'vim-commentary', 'indent-blankline.nvim', 'vim-swap', 'vim-highlighturl', 'lualine.nvim', 'vim-indent-object', 'vim-matchup', 'alpha-nvim', 'open-browser.vim', 'AutoSave.nvim', 'vim-sandwich', 'vim-repeat', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'gh.nvim', 'copilot.lua', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'cmp-buffer', 'cmp-cmdline', 'presence.nvim', 'cmp-nvim-lsp', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'cmp-path', 'cmp-tabnine', 'trouble.nvim', 'hlargs.nvim', 'nvim-ts-rainbow', 'instant.nvim', 'vim-kitty', 'nvim-autopairs', 'vimtex', 'vim-signify', 'nvim-notify', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
