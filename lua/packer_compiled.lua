...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "copilot-cmp", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-nvim-lsp", "cmp-tabnine", "cmp-buffer" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-matchup', 'vim-repeat', 'vim-sandwich', 'open-browser.vim', 'whitespace.nvim', 'targets.vim', 'indent-blankline.nvim', 'kommentary', 'unicode.vim', 'which-key.nvim', 'lualine.nvim', 'vim-swap', 'vim-asterisk', 'vim-hexokinase', 'hop.nvim', 'neoscroll.nvim', 'auto-save.nvim', 'vim-highlighturl', 'vim-indent-object', 'alpha-nvim', 'bufferline.nvim', 'nvim-dap'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-notify', 'nvim-ts-rainbow', 'vim-signify', 'cmp-path', 'vimtex', 'renamer.nvim', 'spotify.nvim', 'hlargs.nvim', 'instant.nvim', 'presence.nvim', 'trouble.nvim', 'blamer.nvim', 'cmp-cmdline', 'refactoring.nvim', 'cmp-nvim-lsp', 'cmp-tabnine', 'nvim-autopairs', 'vim-kitty', 'cmp-buffer'}, { event = "BufEnter *" }, _G.packer_plugins)]]
