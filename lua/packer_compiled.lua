...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'nvim-cmp', 'vim-matchup', 'nvim-web-devicons', 'alpha-nvim', 'vim-repeat', 'vim-sandwich', 'bufferline.nvim', 'targets.vim', 'vim-swap', 'which-key.nvim', 'cmp-tabnine', 'whitespace.nvim', 'vim-commentary', 'AutoSave.nvim', 'vim-highlighturl', 'vim-indent-object', 'indent-blankline.nvim', 'hop.nvim', 'vim-asterisk', 'open-browser.vim', 'unicode.vim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'ultisnips', 'delimitMate', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-notify', 'vim-signify', 'hlargs.nvim', 'blamer.nvim', 'nvim-ts-rainbow', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
