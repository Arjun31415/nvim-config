...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-repeat', 'vim-sandwich', 'bufferline.nvim', 'vim-swap', 'which-key.nvim', 'hop.nvim', 'whitespace.nvim', 'indent-blankline.nvim', 'lspkind-nvim', 'lualine.nvim', 'neoscroll.nvim', 'unicode.vim', 'vim-asterisk', 'nvim-web-devicons', 'vim-highlighturl', 'vim-indent-object', 'AutoSave.nvim', 'targets.vim', 'vim-matchup', 'vim-commentary', 'alpha-nvim', 'open-browser.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'vim-signify', 'hlargs.nvim', 'instant.nvim', 'nvim-colorizer.lua', 'nvim-notify', 'nvim-ts-rainbow', 'BuildTask.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
