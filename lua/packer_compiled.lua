...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "copilot-cmp", "cmp-path", "cmp-tabnine" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'alpha-nvim', 'open-browser.vim', 'which-key.nvim', 'whitespace.nvim', 'targets.vim', 'hop.nvim', 'indent-blankline.nvim', 'unicode.vim', 'kommentary', 'vim-asterisk', 'lualine.nvim', 'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'neoscroll.nvim', 'vim-matchup', 'vim-swap', 'auto-save.nvim', 'vim-sandwich', 'nvim-dap', 'vim-repeat', 'bufferline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-notify', 'vim-signify', 'nvim-ts-rainbow', 'vimtex', 'cmp-buffer', 'presence.nvim', 'refactoring.nvim', 'cmp-cmdline', 'renamer.nvim', 'cmp-nvim-lsp', 'spotify.nvim', 'cmp-path', 'cmp-tabnine', 'hlargs.nvim', 'trouble.nvim', 'instant.nvim', 'blamer.nvim', 'vim-kitty', 'nvim-autopairs'}, { event = "BufEnter *" }, _G.packer_plugins)]]
