...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-asterisk', 'kommentary', 'neoscroll.nvim', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'vim-repeat', 'open-browser.vim', 'vim-sandwich', 'indent-blankline.nvim', 'vim-swap', 'hop.nvim', 'which-key.nvim', 'unicode.vim', 'whitespace.nvim', 'AutoSave.nvim', 'targets.vim', 'alpha-nvim', 'lualine.nvim', 'bufferline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp', 'nvim-autopairs', 'vim-kitty', 'nvim-notify', 'nvim-ts-rainbow', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'vimtex', 'cmp-path', 'cmp-tabnine', 'vim-signify', 'hlargs.nvim', 'trouble.nvim', 'blamer.nvim', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
