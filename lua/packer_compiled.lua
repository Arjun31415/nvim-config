...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'AutoSave.nvim', 'alpha-nvim', 'bufferline.nvim', 'open-browser.vim', 'targets.vim', 'lualine.nvim', 'vim-repeat', 'hop.nvim', 'vim-commentary', 'nvim-web-devicons', 'indent-blankline.nvim', 'vim-swap', 'vim-asterisk', 'which-key.nvim', 'unicode.vim', 'whitespace.nvim', 'neoscroll.nvim', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-colorizer.lua', 'blamer.nvim', 'cmp-buffer', 'cmp-cmdline', 'nvim-notify', 'cmp-nvim-lsp', 'cmp-nvim-ultisnips', 'nvim-ts-rainbow', 'cmp-path', 'cmp-tabnine', 'presence.nvim', 'nvim-cmp', 'spotify.nvim', 'hlargs.nvim', 'trouble.nvim', 'vim-signify', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
