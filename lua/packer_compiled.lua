...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-colorizer.lua', 'nvim-cmp', 'nvim-notify', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-nvim-ultisnips', 'cmp-path', 'cmp-tabnine', 'spotify.nvim', 'vim-signify', 'nvim-ts-rainbow', 'hlargs.nvim', 'cmp-buffer', 'instant.nvim', 'blamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'AutoSave.nvim', 'vim-repeat', 'vim-sandwich', 'alpha-nvim', 'targets.vim', 'vim-swap', 'which-key.nvim', 'bufferline.nvim', 'whitespace.nvim', 'unicode.vim', 'vim-commentary', 'vim-asterisk', 'hop.nvim', 'indent-blankline.nvim', 'open-browser.vim', 'nvim-web-devicons', 'lualine.nvim', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
