...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'gh.nvim', 'copilot.lua', 'ultisnips', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-nvim-lsp', 'cmp-nvim-ultisnips', 'cmp-path', 'trouble.nvim', 'hlargs.nvim', 'instant.nvim', 'nvim-autopairs', 'nvim-cmp', 'nvim-colorizer.lua', 'nvim-notify', 'cmp-tabnine', 'nvim-ts-rainbow', 'vim-signify', 'blamer.nvim', 'presence.nvim', 'spotify.nvim', 'cmp-buffer', 'cmp-cmdline'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'vim-highlighturl', 'vim-indent-object', 'lualine.nvim', 'vim-matchup', 'neoscroll.nvim', 'vim-sandwich', 'AutoSave.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'vim-asterisk', 'alpha-nvim', 'open-browser.vim', 'vim-repeat', 'bufferline.nvim', 'unicode.vim', 'vim-commentary', 'targets.vim', 'vim-swap', 'which-key.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
