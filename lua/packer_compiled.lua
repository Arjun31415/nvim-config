...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "copilot-cmp", "cmp-cmdline" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'alpha-nvim', 'auto-save.nvim', 'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'vim-asterisk', 'vim-matchup', 'neoscroll.nvim', 'vim-repeat', 'targets.vim', 'vim-sandwich', 'nvim-dap', 'vim-swap', 'hop.nvim', 'which-key.nvim', 'indent-blankline.nvim', 'whitespace.nvim', 'kommentary', 'open-browser.vim', 'bufferline.nvim', 'lualine.nvim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'spotify.nvim', 'cmp-buffer', 'nvim-autopairs', 'cmp-nvim-lsp', 'cmp-path', 'cmp-tabnine', 'trouble.nvim', 'vim-signify', 'hlargs.nvim', 'vim-kitty', 'vimtex', 'nvim-notify', 'presence.nvim', 'instant.nvim', 'cmp-cmdline', 'nvim-ts-rainbow', 'blamer.nvim', 'refactoring.nvim', 'renamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
