...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-json', 'vim-markdown', 'markdown-preview.nvim', 'vim-markdownfootnotes'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'whitespace.nvim', 'alpha-nvim', 'auto-save.nvim', 'bufferline.nvim', 'unicode.vim', 'vim-asterisk', 'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'hop.nvim', 'targets.vim', 'nvim-dap', 'vim-matchup', 'vim-swap', 'kommentary', 'vim-repeat', 'lualine.nvim', 'vim-sandwich', 'neoscroll.nvim', 'open-browser.vim', 'indent-blankline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'presence.nvim', 'refactoring.nvim', 'spotify.nvim', 'blamer.nvim', 'cmp-buffer', 'trouble.nvim', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-path', 'cmp-tabnine', 'vimtex', 'hlargs.nvim', 'vim-kitty', 'renamer.nvim', 'nvim-autopairs', 'instant.nvim', 'nvim-notify', 'vim-signify', 'nvim-ts-rainbow'}, { event = "BufEnter *" }, _G.packer_plugins)]]
