...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-buffer", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-path", "copilot-cmp", "cmp-tabnine" },
    loaded = true,
    only_config = true
  },
  ["nvim-gdb"] = {
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-notify', 'blamer.nvim', 'cmp-nvim-lsp', 'cmp-buffer', 'cmp-cmdline', 'nvim-ts-rainbow', 'refactoring.nvim', 'cmp-path', 'trouble.nvim', 'vim-signify', 'instant.nvim', 'vim-kitty', 'vimtex', 'hlargs.nvim', 'renamer.nvim', 'presence.nvim', 'spotify.nvim', 'cmp-tabnine'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'ultisnips', 'gh.nvim', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'unicode.vim', 'vim-asterisk', 'AutoSave.nvim', 'vim-highlighturl', 'vim-indent-object', 'open-browser.vim', 'vim-matchup', 'targets.vim', 'indent-blankline.nvim', 'vim-repeat', 'bufferline.nvim', 'kommentary', 'vim-swap', 'which-key.nvim', 'lualine.nvim', 'whitespace.nvim', 'hop.nvim', 'alpha-nvim', 'neoscroll.nvim', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
