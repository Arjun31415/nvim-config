...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-tabnine", "copilot-cmp", "cmp-path", "cmp-buffer" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'open-browser.vim', 'AutoSave.nvim', 'targets.vim', 'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'vim-asterisk', 'vim-matchup', 'lualine.nvim', 'vim-repeat', 'vim-sandwich', 'unicode.vim', 'hop.nvim', 'indent-blankline.nvim', 'vim-swap', 'kommentary', 'which-key.nvim', 'whitespace.nvim', 'nvim-dap', 'bufferline.nvim', 'alpha-nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-ts-rainbow', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'blamer.nvim', 'trouble.nvim', 'cmp-cmdline', 'vim-kitty', 'cmp-nvim-lsp', 'cmp-tabnine', 'nvim-notify', 'cmp-path', 'hlargs.nvim', 'vim-signify', 'cmp-buffer', 'nvim-autopairs', 'vimtex', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
