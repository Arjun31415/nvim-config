...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lsp", "copilot-cmp", "cmp-nvim-ultisnips", "cmp-path" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'whitespace.nvim', 'vim-matchup', 'alpha-nvim', 'auto-save.nvim', 'nvim-dap', 'bufferline.nvim', 'open-browser.vim', 'indent-blankline.nvim', 'vim-swap', 'kommentary', 'targets.vim', 'hop.nvim', 'lualine.nvim', 'unicode.vim', 'vim-asterisk', 'neoscroll.nvim', 'which-key.nvim', 'vim-repeat', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'vim-kitty', 'nvim-autopairs', 'blamer.nvim', 'cmp-buffer', 'nvim-notify', 'cmp-tabnine', 'cmp-cmdline', 'nvim-ts-rainbow', 'cmp-nvim-lsp', 'presence.nvim', 'refactoring.nvim', 'spotify.nvim', 'instant.nvim', 'trouble.nvim', 'vimtex', 'cmp-path', 'hlargs.nvim', 'renamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
