...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "copilot-cmp", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'gh.nvim', 'better-escape.vim', 'ultisnips', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-matchup', 'vim-repeat', 'vim-sandwich', 'vim-swap', 'indent-blankline.nvim', 'which-key.nvim', 'open-browser.vim', 'neoscroll.nvim', 'targets.vim', 'AutoSave.nvim', 'alpha-nvim', 'vim-commentary', 'unicode.vim', 'vim-asterisk', 'vim-highlighturl', 'bufferline.nvim', 'lualine.nvim', 'hop.nvim', 'nvim-web-devicons', 'whitespace.nvim', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-tabnine', 'nvim-autopairs', 'hlargs.nvim', 'vim-signify', 'nvim-notify', 'presence.nvim', 'spotify.nvim', 'trouble.nvim', 'instant.nvim', 'cmp-buffer', 'nvim-ts-rainbow', 'nvim-cmp', 'blamer.nvim', 'cmp-cmdline', 'cmp-nvim-lsp', 'nvim-colorizer.lua', 'cmp-path'}, { event = "BufEnter *" }, _G.packer_plugins)]]
