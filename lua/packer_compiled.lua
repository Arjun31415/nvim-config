...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'nvim-autopairs', 'nvim-cmp', 'nvim-notify', 'nvim-ts-rainbow', 'blamer.nvim', 'cmp-buffer', 'cmp-cmdline', 'presence.nvim', 'spotify.nvim', 'instant.nvim', 'cmp-nvim-ultisnips', 'cmp-path', 'cmp-nvim-lsp', 'cmp-tabnine', 'nvim-colorizer.lua', 'trouble.nvim', 'vim-signify'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'vim-highlighturl', 'lualine.nvim', 'neoscroll.nvim', 'AutoSave.nvim', 'alpha-nvim', 'nvim-web-devicons', 'bufferline.nvim', 'vim-indent-object', 'open-browser.vim', 'vim-commentary', 'vim-asterisk', 'targets.vim', 'vim-repeat', 'vim-swap', 'vim-sandwich', 'unicode.vim', 'vim-matchup', 'which-key.nvim', 'whitespace.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
