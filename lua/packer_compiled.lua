...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/arjun/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  ["vim-one"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/arjun/.local/share/nvim/site/pack/packer/opt/vim-one",
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'instant.nvim', 'nvim-notify', 'nvim-ts-rainbow', 'BuildTask.nvim', 'vim-signify', 'nvim-treesitter', 'blamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'lspkind-nvim', 'lualine.nvim', 'unicode.vim', 'vim-asterisk', 'neoscroll.nvim', 'vim-commentary', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'AutoSave.nvim', 'vim-sandwich', 'which-key.nvim', 'targets.vim', 'alpha-nvim', 'vim-swap', 'nvim-web-devicons', 'whitespace.nvim', 'bufferline.nvim', 'open-browser.vim', 'vim-repeat'}, { event = "VimEnter *" }, _G.packer_plugins)]]
