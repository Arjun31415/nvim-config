...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-asterisk', 'vim-commentary', 'AutoSave.nvim', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'bufferline.nvim', 'vim-repeat', 'vim-sandwich', 'hop.nvim', 'vim-swap', 'which-key.nvim', 'lspkind-nvim', 'lualine.nvim', 'nvim-web-devicons', 'open-browser.vim', 'neoscroll.nvim', 'targets.vim', 'whitespace.nvim', 'alpha-nvim', 'indent-blankline.nvim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'BuildTask.nvim', 'blamer.nvim', 'hlargs.nvim', 'vim-signify', 'instant.nvim', 'nvim-notify', 'nvim-ts-rainbow', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
