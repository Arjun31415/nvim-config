...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-path", "cmp-nvim-lsp", "copilot-cmp", "cmp-tabnine" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-colorizer.lua', 'nvim-notify', 'cmp-buffer', 'nvim-ts-rainbow', 'cmp-cmdline', 'presence.nvim', 'cmp-path', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'vim-signify', 'trouble.nvim', 'blamer.nvim', 'vimtex', 'hlargs.nvim', 'cmp-nvim-lsp', 'cmp-tabnine', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'AutoSave.nvim', 'alpha-nvim', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'open-browser.vim', 'vim-repeat', 'vim-sandwich', 'targets.vim', 'vim-commentary', 'vim-swap', 'which-key.nvim', 'unicode.vim', 'whitespace.nvim', 'lualine.nvim', 'vim-asterisk', 'indent-blankline.nvim', 'bufferline.nvim', 'hop.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
