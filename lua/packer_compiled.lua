...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'vim-kitty', 'vim-signify', 'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-path', 'cmp-tabnine', 'nvim-notify', 'nvim-ts-rainbow', 'hlargs.nvim', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'instant.nvim', 'spotify.nvim', 'nvim-autopairs', 'trouble.nvim', 'vimtex'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-indent-object', 'vim-swap', 'vim-matchup', 'which-key.nvim', 'whitespace.nvim', 'alpha-nvim', 'auto-save.nvim', 'open-browser.vim', 'hop.nvim', 'indent-blankline.nvim', 'kommentary', 'targets.vim', 'vim-highlighturl', 'lualine.nvim', 'vim-hexokinase', 'unicode.vim', 'vim-asterisk', 'vim-sandwich', 'vim-repeat', 'nvim-dap', 'neoscroll.nvim', 'bufferline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
