...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'open-browser.vim', 'vim-commentary', 'targets.vim', 'AutoSave.nvim', 'vim-highlighturl', 'vim-indent-object', 'bufferline.nvim', 'hop.nvim', 'vim-matchup', 'indent-blankline.nvim', 'lualine.nvim', 'vim-sandwich', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'vim-repeat', 'alpha-nvim', 'vim-asterisk', 'unicode.vim', 'neoscroll.nvim', 'nvim-web-devicons'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'presence.nvim', 'spotify.nvim', 'nvim-cmp', 'trouble.nvim', 'hlargs.nvim', 'cmp-buffer', 'instant.nvim', 'cmp-nvim-ultisnips', 'cmp-path', 'cmp-tabnine', 'vim-signify', 'nvim-autopairs', 'nvim-colorizer.lua', 'nvim-notify', 'cmp-cmdline', 'blamer.nvim', 'nvim-ts-rainbow', 'cmp-nvim-lsp'}, { event = "BufEnter *" }, _G.packer_plugins)]]
