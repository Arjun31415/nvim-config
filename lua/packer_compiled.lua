...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "copilot-cmp" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-json', 'vim-markdownfootnotes', 'vim-markdown', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'trouble.nvim', 'instant.nvim', 'vim-signify', 'renamer.nvim', 'blamer.nvim', 'spotify.nvim', 'cmp-buffer', 'nvim-notify', 'cmp-cmdline', 'cmp-nvim-lsp', 'nvim-ts-rainbow', 'refactoring.nvim', 'cmp-path', 'cmp-tabnine', 'vimtex', 'presence.nvim', 'nvim-autopairs', 'vim-kitty'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'kommentary', 'unicode.vim', 'vim-asterisk', 'lualine.nvim', 'vim-highlighturl', 'neoscroll.nvim', 'vim-sandwich', 'vim-matchup', 'bufferline.nvim', 'vim-repeat', 'alpha-nvim', 'vim-swap', 'open-browser.vim', 'which-key.nvim', 'whitespace.nvim', 'AutoSave.nvim', 'vim-indent-object', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
