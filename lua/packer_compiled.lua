...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'spotify.nvim', 'nvim-cmp', 'instant.nvim', 'blamer.nvim', 'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-path', 'cmp-tabnine', 'nvim-notify', 'trouble.nvim', 'nvim-colorizer.lua', 'vim-signify', 'nvim-ts-rainbow', 'hlargs.nvim', 'cmp-nvim-ultisnips', 'nvim-autopairs', 'presence.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'AutoSave.nvim', 'lualine.nvim', 'alpha-nvim', 'bufferline.nvim', 'vim-swap', 'neoscroll.nvim', 'vim-matchup', 'targets.vim', 'open-browser.vim', 'vim-repeat', 'vim-sandwich', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'which-key.nvim', 'nvim-web-devicons', 'whitespace.nvim', 'vim-highlighturl', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'better-escape.vim', 'gh.nvim', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
