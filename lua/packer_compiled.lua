...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'nvim-dap', 'open-browser.vim', 'alpha-nvim', 'vim-asterisk', 'auto-save.nvim', 'lualine.nvim', 'vim-swap', 'bufferline.nvim', 'hop.nvim', 'whitespace.nvim', 'indent-blankline.nvim', 'kommentary', 'vim-repeat', 'unicode.vim', 'targets.vim', 'neoscroll.nvim', 'vim-sandwich', 'which-key.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-kitty', 'nvim-autopairs', 'nvim-notify', 'nvim-ts-rainbow', 'vim-signify', 'cmp-nvim-lsp', 'cmp-tabnine', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'cmp-buffer', 'vimtex', 'hlargs.nvim', 'cmp-cmdline', 'blamer.nvim', 'instant.nvim', 'cmp-path', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
