...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-tabnine", "cmp-path", "copilot-cmp", "cmp-cmdline" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'lualine.nvim', 'neoscroll.nvim', 'vim-highlighturl', 'vim-indent-object', 'alpha-nvim', 'vim-matchup', 'bufferline.nvim', 'hop.nvim', 'nvim-web-devicons', 'vim-repeat', 'vim-sandwich', 'vim-swap', 'which-key.nvim', 'targets.vim', 'whitespace.nvim', 'AutoSave.nvim', 'open-browser.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'instant.nvim', 'nvim-autopairs', 'cmp-buffer', 'blamer.nvim', 'hlargs.nvim', 'trouble.nvim', 'cmp-nvim-lsp', 'nvim-notify', 'cmp-tabnine', 'vim-signify', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'cmp-path', 'spotify.nvim', 'vimtex', 'nvim-ts-rainbow', 'cmp-cmdline', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
