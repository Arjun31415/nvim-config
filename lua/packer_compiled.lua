...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "copilot-cmp", "cmp-nvim-lsp" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-notify', 'nvim-ts-rainbow', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'blamer.nvim', 'vim-kitty', 'nvim-autopairs', 'cmp-buffer', 'spotify.nvim', 'cmp-cmdline', 'trouble.nvim', 'instant.nvim', 'cmp-path', 'cmp-tabnine', 'vim-signify', 'hlargs.nvim', 'vimtex', 'cmp-nvim-lsp', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'open-browser.vim', 'AutoSave.nvim', 'alpha-nvim', 'vim-indent-object', 'lualine.nvim', 'targets.vim', 'bufferline.nvim', 'unicode.vim', 'vim-sandwich', 'indent-blankline.nvim', 'vim-matchup', 'vim-asterisk', 'vim-commentary', 'neoscroll.nvim', 'vim-highlighturl', 'vim-swap', 'hop.nvim', 'vim-repeat', 'which-key.nvim', 'whitespace.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
