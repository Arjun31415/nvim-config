...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "copilot-cmp", "cmp-nvim-ultisnips", "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp-nvim-lsp", "cmp-tabnine" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'vimtex', 'nvim-notify', 'presence.nvim', 'vim-signify', 'refactoring.nvim', 'renamer.nvim', 'nvim-ts-rainbow', 'spotify.nvim', 'trouble.nvim', 'instant.nvim', 'blamer.nvim', 'cmp-buffer', 'cmp-path', 'vim-kitty', 'cmp-cmdline', 'nvim-autopairs', 'cmp-nvim-lsp', 'nvim-colorizer.lua', 'cmp-tabnine'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'gh.nvim', 'ultisnips', 'better-escape.vim', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-repeat', 'vim-sandwich', 'hop.nvim', 'vim-swap', 'indent-blankline.nvim', 'which-key.nvim', 'whitespace.nvim', 'open-browser.vim', 'vim-commentary', 'AutoSave.nvim', 'unicode.vim', 'lualine.nvim', 'alpha-nvim', 'vim-asterisk', 'neoscroll.nvim', 'vim-indent-object', 'bufferline.nvim', 'vim-highlighturl', 'vim-matchup', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
