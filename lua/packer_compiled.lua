...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'hlargs.nvim', 'instant.nvim', 'nvim-notify', 'nvim-ts-rainbow', 'nvim-colorizer.lua', 'vim-signify', 'BuildTask.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'alpha-nvim', 'whitespace.nvim', 'open-browser.vim', 'indent-blankline.nvim', 'unicode.vim', 'lspkind-nvim', 'vim-asterisk', 'lualine.nvim', 'vim-commentary', 'neoscroll.nvim', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'nvim-web-devicons', 'vim-repeat', 'vim-sandwich', 'hop.nvim', 'AutoSave.nvim', 'bufferline.nvim', 'targets.vim', 'vim-swap'}, { event = "VimEnter *" }, _G.packer_plugins)]]
