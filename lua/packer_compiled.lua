...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "copilot-cmp", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-tabnine", "cmp-buffer", "cmp-path", "cmp-cmdline" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'unicode.vim', 'auto-save.nvim', 'vim-asterisk', 'bufferline.nvim', 'vim-indent-object', 'open-browser.vim', 'vim-matchup', 'vim-swap', 'hop.nvim', 'vim-repeat', 'vim-sandwich', 'vim-hexokinase', 'targets.vim', 'kommentary', 'indent-blankline.nvim', 'alpha-nvim', 'vim-highlighturl', 'which-key.nvim', 'nvim-dap', 'whitespace.nvim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-notify', 'cmp-nvim-lsp', 'spotify.nvim', 'nvim-ts-rainbow', 'vim-kitty', 'cmp-tabnine', 'blamer.nvim', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'vimtex', 'cmp-buffer', 'hlargs.nvim', 'cmp-path', 'vim-signify', 'cmp-cmdline', 'instant.nvim', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
