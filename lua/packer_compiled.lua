...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'ultisnips', 'delimitMate', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-repeat', 'vim-sandwich', 'vim-swap', 'which-key.nvim', 'AutoSave.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'open-browser.vim', 'bufferline.nvim', 'targets.vim', 'cmp-tabnine', 'vim-asterisk', 'vim-commentary', 'nvim-cmp', 'hop.nvim', 'vim-highlighturl', 'indent-blankline.nvim', 'lualine.nvim', 'vim-matchup', 'alpha-nvim', 'vim-indent-object', 'unicode.vim', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
