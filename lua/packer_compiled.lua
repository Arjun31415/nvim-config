...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-tabnine", "copilot-cmp", "cmp-nvim-lsp", "cmp-nvim-ultisnips" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'markdown-preview.nvim', 'vim-json', 'vim-markdownfootnotes'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'unicode.vim', 'vim-asterisk', 'neoscroll.nvim', 'alpha-nvim', 'vim-hexokinase', 'vim-highlighturl', 'auto-save.nvim', 'vim-indent-object', 'nvim-dap', 'vim-matchup', 'vim-repeat', 'open-browser.vim', 'vim-swap', 'which-key.nvim', 'hop.nvim', 'bufferline.nvim', 'whitespace.nvim', 'indent-blankline.nvim', 'kommentary', 'targets.vim', 'vim-sandwich', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'copilot.lua', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-autopairs', 'blamer.nvim', 'cmp-buffer', 'nvim-notify', 'cmp-cmdline', 'nvim-ts-rainbow', 'cmp-path', 'cmp-tabnine', 'presence.nvim', 'vim-signify', 'refactoring.nvim', 'vimtex', 'hlargs.nvim', 'renamer.nvim', 'vim-kitty', 'instant.nvim', 'cmp-nvim-lsp', 'spotify.nvim', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
