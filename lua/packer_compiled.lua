...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'instant.nvim', 'nvim-cmp', 'nvim-notify', 'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-ultisnips', 'cmp-nvim-lsp', 'spotify.nvim', 'nvim-colorizer.lua', 'vim-signify', 'cmp-path', 'cmp-tabnine', 'nvim-ts-rainbow', 'blamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'vim-highlighturl', 'indent-blankline.nvim', 'lualine.nvim', 'neoscroll.nvim', 'vim-matchup', 'alpha-nvim', 'nvim-web-devicons', 'vim-repeat', 'vim-commentary', 'vim-sandwich', 'vim-asterisk', 'open-browser.vim', 'vim-swap', 'which-key.nvim', 'bufferline.nvim', 'AutoSave.nvim', 'unicode.vim', 'whitespace.nvim', 'targets.vim', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
