...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "copilot-cmp", "cmp-buffer" },
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-kitty', 'nvim-notify', 'vimtex', 'presence.nvim', 'refactoring.nvim', 'blamer.nvim', 'vim-signify', 'renamer.nvim', 'cmp-tabnine', 'hlargs.nvim', 'spotify.nvim', 'nvim-autopairs', 'cmp-cmdline', 'cmp-nvim-lsp', 'nvim-ts-rainbow', 'cmp-path', 'trouble.nvim', 'instant.nvim', 'cmp-buffer'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-highlighturl', 'indent-blankline.nvim', 'vim-indent-object', 'vim-matchup', 'nvim-dap', 'vim-sandwich', 'vim-swap', 'open-browser.vim', 'which-key.nvim', 'whitespace.nvim', 'vim-hexokinase', 'hop.nvim', 'bufferline.nvim', 'lualine.nvim', 'targets.vim', 'kommentary', 'alpha-nvim', 'unicode.vim', 'vim-asterisk', 'vim-repeat', 'auto-save.nvim', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
