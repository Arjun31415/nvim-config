...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'delimitMate', 'copilot.lua', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'open-browser.vim', 'bufferline.nvim', 'vim-repeat', 'vim-sandwich', 'cmp-tabnine', 'vim-swap', 'unicode.vim', 'whitespace.nvim', 'hop.nvim', 'indent-blankline.nvim', 'lspkind-nvim', 'lualine.nvim', 'neoscroll.nvim', 'vim-asterisk', 'vim-matchup', 'nvim-cmp', 'AutoSave.nvim', 'vim-highlighturl', 'vim-indent-object', 'which-key.nvim', 'alpha-nvim', 'vim-commentary', 'nvim-web-devicons', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'instant.nvim', 'hlargs.nvim', 'nvim-colorizer.lua', 'vim-signify', 'nvim-notify', 'nvim-ts-rainbow'}, { event = "BufEnter *" }, _G.packer_plugins)]]
