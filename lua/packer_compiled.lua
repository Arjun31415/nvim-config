...
_G.packer_plugins = {
  ...
  ["parinfer-rust"] = {
    loaded = true,
    path = "/home/arjun/.local/share/nvim/site/pack/packer/start/parinfer-rust",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-repeat', 'vim-sandwich', 'hop.nvim', 'indent-blankline.nvim', 'vim-swap', 'open-browser.vim', 'lualine.nvim', 'whitespace.nvim', 'neoscroll.nvim', 'targets.vim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'AutoSave.nvim', 'bufferline.nvim', 'alpha-nvim', 'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'which-key.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'nvim-ts-rainbow', 'vimtex', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'trouble.nvim', 'nvim-colorizer.lua', 'cmp-buffer', 'nvim-notify', 'cmp-cmdline', 'blamer.nvim', 'cmp-nvim-lsp', 'cmp-path', 'vim-kitty', 'cmp-tabnine', 'nvim-autopairs', 'vim-signify', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'gh.nvim', 'ultisnips', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
