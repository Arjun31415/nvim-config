...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-markdownfootnotes', 'vim-markdown', 'vim-json'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-ts-rainbow', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'blamer.nvim', 'cmp-buffer', 'trouble.nvim', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-path', 'cmp-tabnine', 'vim-signify', 'nvim-notify', 'hlargs.nvim', 'vim-kitty', 'nvim-autopairs', 'instant.nvim', 'vimtex'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lualine.nvim', 'open-browser.vim', 'alpha-nvim', 'auto-save.nvim', 'bufferline.nvim', 'vim-repeat', 'nvim-dap', 'which-key.nvim', 'unicode.vim', 'whitespace.nvim', 'vim-asterisk', 'vim-sandwich', 'targets.vim', 'indent-blankline.nvim', 'vim-hexokinase', 'vim-highlighturl', 'neoscroll.nvim', 'hop.nvim', 'vim-indent-object', 'vim-matchup', 'vim-swap', 'kommentary'}, { event = "VimEnter *" }, _G.packer_plugins)]]
