...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'lspkind-nvim', 'lualine.nvim', 'neoscroll.nvim', 'vim-highlighturl', 'vim-matchup', 'AutoSave.nvim', 'vim-repeat', 'alpha-nvim', 'vim-sandwich', 'bufferline.nvim', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'nvim-cmp', 'cmp-tabnine', 'open-browser.vim', 'targets.vim', 'nvim-web-devicons', 'hop.nvim', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'copilot.lua', 'ultisnips', 'delimitMate'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'instant.nvim', 'nvim-colorizer.lua', 'BuildTask.nvim', 'nvim-notify', 'nvim-ts-rainbow', 'vim-signify', 'blamer.nvim', 'hlargs.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
