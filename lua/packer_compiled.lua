...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-notify', 'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-path', 'cmp-tabnine', 'nvim-cmp', 'gh.nvim', 'hlargs.nvim', 'blamer.nvim', 'instant.nvim', 'spotify.nvim', 'vim-signify', 'cmp-nvim-ultisnips', 'presence.nvim', 'trouble.nvim', 'nvim-autopairs', 'nvim-ts-rainbow'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-commentary', 'alpha-nvim', 'vim-indent-object', 'nvim-web-devicons', 'open-browser.vim', 'vim-matchup', 'whitespace.nvim', 'targets.vim', 'vim-repeat', 'vim-sandwich', 'hop.nvim', 'vim-swap', 'indent-blankline.nvim', 'which-key.nvim', 'vim-highlighturl', 'bufferline.nvim', 'lualine.nvim', 'neoscroll.nvim', 'AutoSave.nvim', 'unicode.vim', 'vim-asterisk'}, { event = "VimEnter *" }, _G.packer_plugins)]]
