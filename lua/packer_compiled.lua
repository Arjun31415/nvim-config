...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-tabnine", "copilot-cmp", "cmp-buffer", "cmp-cmdline", "cmp-path" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-json', 'markdown-preview.nvim', 'vim-markdown', 'vim-markdownfootnotes'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-matchup', 'open-browser.vim', 'which-key.nvim', 'whitespace.nvim', 'vim-repeat', 'targets.vim', 'kommentary', 'hop.nvim', 'indent-blankline.nvim', 'bufferline.nvim', 'alpha-nvim', 'vim-swap', 'lualine.nvim', 'vim-asterisk', 'vim-highlighturl', 'neoscroll.nvim', 'vim-indent-object', 'unicode.vim', 'vim-sandwich', 'AutoSave.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'copilot.lua', 'gh.nvim', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-notify', 'nvim-ts-rainbow', 'cmp-nvim-lsp', 'vimtex', 'cmp-tabnine', 'spotify.nvim', 'vim-signify', 'instant.nvim', 'hlargs.nvim', 'blamer.nvim', 'nvim-autopairs', 'cmp-buffer', 'cmp-cmdline', 'cmp-path', 'renamer.nvim', 'presence.nvim', 'trouble.nvim', 'vim-kitty', 'refactoring.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
