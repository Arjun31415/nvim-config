...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "copilot-cmp", "cmp-cmdline", "cmp-buffer" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'gh.nvim', 'ultisnips', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'instant.nvim', 'cmp-nvim-lsp', 'vim-signify', 'cmp-path', 'cmp-tabnine', 'vimtex', 'presence.nvim', 'nvim-autopairs', 'nvim-colorizer.lua', 'refactoring.nvim', 'cmp-cmdline', 'renamer.nvim', 'spotify.nvim', 'blamer.nvim', 'nvim-notify', 'cmp-buffer', 'nvim-ts-rainbow', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-asterisk', 'vim-commentary', 'AutoSave.nvim', 'vim-indent-object', 'hop.nvim', 'alpha-nvim', 'indent-blankline.nvim', 'vim-matchup', 'lualine.nvim', 'vim-repeat', 'vim-sandwich', 'neoscroll.nvim', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'targets.vim', 'vim-highlighturl', 'bufferline.nvim', 'open-browser.vim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
