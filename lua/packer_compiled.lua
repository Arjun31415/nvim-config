...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-colorizer.lua', 'nvim-ts-rainbow', 'nvim-cmp', 'presence.nvim', 'spotify.nvim', 'blamer.nvim', 'vim-signify', 'cmp-buffer', 'trouble.nvim', 'nvim-notify', 'cmp-cmdline', 'cmp-nvim-lsp', 'hlargs.nvim', 'cmp-path', 'cmp-tabnine', 'cmp-nvim-ultisnips', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lualine.nvim', 'vim-matchup', 'neoscroll.nvim', 'vim-repeat', 'vim-sandwich', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'AutoSave.nvim', 'open-browser.vim', 'targets.vim', 'alpha-nvim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'hop.nvim', 'indent-blankline.nvim', 'bufferline.nvim', 'vim-highlighturl', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
