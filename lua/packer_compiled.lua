...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-path', 'presence.nvim', 'cmp-tabnine', 'trouble.nvim', 'gh.nvim', 'hlargs.nvim', 'nvim-cmp', 'instant.nvim', 'nvim-autopairs', 'cmp-buffer', 'vim-signify', 'nvim-colorizer.lua', 'blamer.nvim', 'nvim-notify', 'spotify.nvim', 'nvim-ts-rainbow', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-nvim-ultisnips'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'unicode.vim', 'hop.nvim', 'vim-asterisk', 'vim-commentary', 'indent-blankline.nvim', 'lualine.nvim', 'neoscroll.nvim', 'vim-matchup', 'alpha-nvim', 'vim-indent-object', 'nvim-web-devicons', 'vim-highlighturl', 'bufferline.nvim', 'vim-repeat', 'vim-sandwich', 'AutoSave.nvim', 'whitespace.nvim', 'open-browser.vim', 'vim-swap', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
