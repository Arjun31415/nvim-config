...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'vimtex', 'nvim-notify', 'blamer.nvim', 'nvim-ts-rainbow', 'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp', 'presence.nvim', 'trouble.nvim', 'refactoring.nvim', 'renamer.nvim', 'cmp-tabnine', 'nvim-autopairs', 'spotify.nvim', 'cmp-path', 'hlargs.nvim', 'vim-kitty', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-repeat', 'alpha-nvim', 'vim-sandwich', 'vim-swap', 'which-key.nvim', 'nvim-dap', 'whitespace.nvim', 'auto-save.nvim', 'bufferline.nvim', 'open-browser.vim', 'neoscroll.nvim', 'unicode.vim', 'vim-asterisk', 'indent-blankline.nvim', 'vim-hexokinase', 'hop.nvim', 'vim-highlighturl', 'vim-indent-object', 'kommentary', 'lualine.nvim', 'vim-matchup', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
