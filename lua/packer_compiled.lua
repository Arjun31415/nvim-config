...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate', 'copilot.lua', 'better-escape.vim', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'hlargs.nvim', 'instant.nvim', 'nvim-notify', 'nvim-ts-rainbow', 'blamer.nvim', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-swap', 'hop.nvim', 'indent-blankline.nvim', 'AutoSave.nvim', 'lualine.nvim', 'nvim-web-devicons', 'open-browser.vim', 'neoscroll.nvim', 'targets.vim', 'which-key.nvim', 'unicode.vim', 'whitespace.nvim', 'vim-asterisk', 'vim-commentary', 'bufferline.nvim', 'lspkind-nvim', 'vim-highlighturl', 'vim-repeat', 'vim-indent-object', 'nvim-cmp', 'cmp-tabnine', 'vim-matchup', 'alpha-nvim', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
