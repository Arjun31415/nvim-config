...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "copilot-cmp", "cmp-tabnine", "cmp-nvim-ultisnips", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-path" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-fzf-native.nvim", "telescope-symbols.nvim" },
    commands = { "Telescope" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdownfootnotes', 'vim-markdown', 'markdown-preview.nvim', 'vim-json'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'vimtex'}, { ft = "tex" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'vim-swap', 'vim-matchup', 'indent-blankline.nvim', 'nvim-dap', 'kommentary', 'lualine.nvim', 'hop.nvim', 'which-key.nvim', 'targets.vim', 'auto-save.nvim', 'vim-asterisk', 'vim-sandwich', 'bufferline.nvim', 'open-browser.vim', 'alpha-nvim', 'unicode.vim', 'whitespace.nvim', 'neoscroll.nvim', 'vim-repeat'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'ultisnips', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'vim-kitty', 'vimtex', 'hlargs.nvim', 'nvim-autopairs', 'instant.nvim', 'nvim-notify', 'nvim-ts-rainbow', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'cmp-tabnine', 'spotify.nvim', 'cmp-buffer', 'blamer.nvim', 'trouble.nvim', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-path'}, { event = "BufEnter *" }, _G.packer_plugins)]]
