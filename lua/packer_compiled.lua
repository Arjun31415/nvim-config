...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'alpha-nvim', 'vim-repeat', 'vim-sandwich', 'nvim-cmp', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'bufferline.nvim', 'cmp-tabnine', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'hop.nvim', 'indent-blankline.nvim', 'open-browser.vim', 'AutoSave.nvim', 'lspkind-nvim', 'vim-highlighturl', 'lualine.nvim', 'vim-indent-object', 'targets.vim', 'neoscroll.nvim', 'vim-matchup', 'nvim-web-devicons'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'delimitMate', 'ultisnips', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'BuildTask.nvim', 'nvim-colorizer.lua', 'vim-signify', 'nvim-notify', 'nvim-ts-rainbow', 'hlargs.nvim', 'instant.nvim', 'blamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
