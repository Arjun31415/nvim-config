...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'AutoSave.nvim', 'targets.vim', 'bufferline.nvim', 'unicode.vim', 'vim-repeat', 'vim-asterisk', 'vim-sandwich', 'vim-commentary', 'indent-blankline.nvim', 'vim-highlighturl', 'whitespace.nvim', 'vim-indent-object', 'lualine.nvim', 'vim-matchup', 'alpha-nvim', 'which-key.nvim', 'neoscroll.nvim', 'hop.nvim', 'nvim-web-devicons', 'open-browser.vim', 'vim-swap'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'presence.nvim', 'spotify.nvim', 'blamer.nvim', 'vim-signify', 'instant.nvim', 'cmp-buffer', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-nvim-ultisnips', 'nvim-autopairs', 'cmp-path', 'cmp-tabnine', 'nvim-colorizer.lua', 'hlargs.nvim', 'nvim-notify', 'nvim-cmp', 'nvim-ts-rainbow', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'gh.nvim', 'copilot.lua', 'ultisnips'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
