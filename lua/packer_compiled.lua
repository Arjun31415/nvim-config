...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'hop.nvim', 'vim-repeat', 'indent-blankline.nvim', 'lualine.nvim', 'vim-swap', 'which-key.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'open-browser.vim', 'targets.vim', 'alpha-nvim', 'neoscroll.nvim', 'unicode.vim', 'bufferline.nvim', 'vim-asterisk', 'AutoSave.nvim', 'vim-commentary', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-tabnine', 'nvim-cmp', 'instant.nvim', 'vim-signify', 'nvim-notify', 'nvim-ts-rainbow', 'nvim-autopairs', 'nvim-colorizer.lua', 'spotify.nvim', 'blamer.nvim', 'cmp-cmdline', 'cmp-buffer', 'cmp-nvim-lsp', 'hlargs.nvim', 'cmp-nvim-ultisnips'}, { event = "BufEnter *" }, _G.packer_plugins)]]
