...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-buffer", "cmp-path", "cmp-tabnine", "copilot-cmp" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-markdown', 'vim-markdownfootnotes', 'vim-json', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'vim-matchup', 'AutoSave.nvim', 'vim-highlighturl', 'open-browser.vim', 'vim-indent-object', 'vim-repeat', 'vim-sandwich', 'hop.nvim', 'alpha-nvim', 'vim-swap', 'targets.vim', 'whitespace.nvim', 'indent-blankline.nvim', 'unicode.vim', 'vim-asterisk', 'bufferline.nvim', 'vim-commentary', 'which-key.nvim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-kitty', 'nvim-autopairs', 'nvim-colorizer.lua', 'nvim-notify', 'nvim-ts-rainbow', 'vimtex', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'vim-signify', 'spotify.nvim', 'cmp-cmdline', 'cmp-nvim-lsp', 'cmp-buffer', 'cmp-path', 'hlargs.nvim', 'cmp-tabnine', 'trouble.nvim', 'instant.nvim', 'blamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'gh.nvim', 'better-escape.vim', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
