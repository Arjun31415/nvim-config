...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'hop.nvim', 'targets.vim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'AutoSave.nvim', 'indent-blankline.nvim', 'alpha-nvim', 'open-browser.vim', 'vim-highlighturl', 'vim-indent-object', 'lualine.nvim', 'bufferline.nvim', 'vim-matchup', 'neoscroll.nvim', 'vim-repeat', 'vim-sandwich', 'vim-swap'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-notify', 'nvim-cmp', 'presence.nvim', 'spotify.nvim', 'trouble.nvim', 'instant.nvim', 'vim-signify', 'gh.nvim', 'cmp-path', 'cmp-cmdline', 'nvim-colorizer.lua', 'cmp-nvim-lsp', 'cmp-nvim-ultisnips', 'nvim-autopairs', 'cmp-tabnine', 'hlargs.nvim', 'nvim-ts-rainbow', 'cmp-buffer', 'blamer.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
