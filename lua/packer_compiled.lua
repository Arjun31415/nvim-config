...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'whitespace.nvim', 'nvim-web-devicons', 'open-browser.vim', 'targets.vim', 'AutoSave.nvim', 'alpha-nvim', 'bufferline.nvim', 'hop.nvim', 'indent-blankline.nvim', 'vim-matchup', 'lspkind-nvim', 'vim-indent-object', 'vim-asterisk', 'neoscroll.nvim', 'vim-commentary', 'vim-repeat', 'unicode.vim', 'vim-sandwich', 'vim-highlighturl', 'lualine.nvim', 'vim-swap'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-notify', 'nvim-ts-rainbow', 'BuildTask.nvim', 'blamer.nvim', 'hlargs.nvim', 'instant.nvim', 'vim-signify', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
