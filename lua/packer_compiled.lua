...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-notify', 'nvim-ts-rainbow', 'vim-signify', 'blamer.nvim', 'hlargs.nvim', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-highlighturl', 'vim-indent-object', 'vim-matchup', 'vim-repeat', 'vim-sandwich', 'nvim-web-devicons', 'vim-swap', 'which-key.nvim', 'AutoSave.nvim', 'targets.vim', 'alpha-nvim', 'nvim-cmp', 'unicode.vim', 'hop.nvim', 'vim-commentary', 'whitespace.nvim', 'open-browser.vim', 'indent-blankline.nvim', 'cmp-tabnine', 'lualine.nvim', 'lspkind-nvim', 'bufferline.nvim', 'vim-asterisk', 'neoscroll.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
