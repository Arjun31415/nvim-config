...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lualine.nvim', 'bufferline.nvim', 'which-key.nvim', 'whitespace.nvim', 'neoscroll.nvim', 'indent-blankline.nvim', 'kommentary', 'vim-hexokinase', 'vim-highlighturl', 'vim-indent-object', 'hop.nvim', 'vim-asterisk', 'targets.vim', 'open-browser.vim', 'AutoSave.nvim', 'nvim-dap', 'vim-matchup', 'vim-swap', 'unicode.vim', 'alpha-nvim', 'vim-repeat', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'blamer.nvim', 'vim-signify', 'cmp-buffer', 'cmp-cmdline', 'vimtex', 'cmp-nvim-lsp', 'cmp-tabnine', 'nvim-notify', 'instant.nvim', 'nvim-ts-rainbow', 'presence.nvim', 'nvim-autopairs', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'vim-kitty', 'hlargs.nvim', 'trouble.nvim', 'cmp-path'}, { event = "BufEnter *" }, _G.packer_plugins)]]
