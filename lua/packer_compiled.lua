...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'instant.nvim', 'vim-signify', 'blamer.nvim', 'nvim-colorizer.lua', 'nvim-notify', 'nvim-ts-rainbow'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-swap', 'targets.vim', 'which-key.nvim', 'whitespace.nvim', 'unicode.vim', 'vim-asterisk', 'vim-commentary', 'hop.nvim', 'AutoSave.nvim', 'indent-blankline.nvim', 'alpha-nvim', 'lualine.nvim', 'nvim-cmp', 'bufferline.nvim', 'vim-indent-object', 'neoscroll.nvim', 'vim-matchup', 'cmp-tabnine', 'nvim-web-devicons', 'vim-repeat', 'open-browser.vim', 'vim-sandwich', 'vim-highlighturl'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'copilot.lua', 'better-escape.vim', 'delimitMate'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
