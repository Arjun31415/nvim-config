...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-repeat', 'unicode.vim', 'lspkind-nvim', 'whitespace.nvim', 'vim-asterisk', 'lualine.nvim', 'bufferline.nvim', 'vim-commentary', 'hop.nvim', 'neoscroll.nvim', 'vim-swap', 'which-key.nvim', 'AutoSave.nvim', 'vim-highlighturl', 'vim-indent-object', 'alpha-nvim', 'nvim-web-devicons', 'open-browser.vim', 'vim-matchup', 'vim-sandwich', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
