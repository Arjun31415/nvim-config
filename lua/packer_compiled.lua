...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-tabnine", "copilot-cmp" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ui-select.nvim", "telescope-symbols.nvim" },
    commands = { "Telescope" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
  ...
  ["vim-pandoc"] = {
    loaded = true,
    path = "/home/arjun/.local/share/nvim/site/pack/packer/start/vim-pandoc",
    url = "https://github.com/vim-pandoc/vim-pandoc"
  },
  ["vim-pandoc-syntax"] = {
    loaded = true,
    path = "/home/arjun/.local/share/nvim/site/pack/packer/start/vim-pandoc-syntax",
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-json', 'vim-markdown', 'vim-markdownfootnotes'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'hlargs.nvim', 'blamer.nvim', 'instant.nvim', 'cmp-buffer', 'nvim-autopairs', 'cmp-nvim-lsp', 'vim-signify', 'nvim-colorizer.lua', 'vimtex', 'nvim-notify', 'cmp-path', 'cmp-cmdline', 'nvim-ts-rainbow', 'vim-kitty', 'cmp-tabnine', 'refactoring.nvim', 'presence.nvim', 'renamer.nvim', 'spotify.nvim', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'ultisnips', 'better-escape.vim', 'gh.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'alpha-nvim', 'indent-blankline.nvim', 'bufferline.nvim', 'kommentary', 'lualine.nvim', 'neoscroll.nvim', 'vim-repeat', 'vim-sandwich', 'AutoSave.nvim', 'vim-swap', 'vim-asterisk', 'whitespace.nvim', 'which-key.nvim', 'unicode.vim', 'vim-highlighturl', 'vim-indent-object', 'open-browser.vim', 'hop.nvim', 'vim-matchup', 'targets.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
