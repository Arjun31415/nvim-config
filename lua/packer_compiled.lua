...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-notify', 'nvim-ts-rainbow', 'presence.nvim', 'spotify.nvim', 'blamer.nvim', 'cmp-cmdline', 'vim-signify', 'cmp-nvim-ultisnips', 'cmp-path', 'nvim-colorizer.lua', 'hlargs.nvim', 'nvim-cmp', 'trouble.nvim', 'cmp-nvim-lsp', 'instant.nvim', 'nvim-autopairs', 'cmp-buffer', 'cmp-tabnine'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { event = "FileType qf" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'better-escape.vim', 'gh.nvim', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au User InGitRepo ++once lua require("packer.load")({'vim-fugitive'}, { event = "User InGitRepo" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neoscroll.nvim', 'open-browser.vim', 'targets.vim', 'bufferline.nvim', 'vim-sandwich', 'lualine.nvim', 'vim-swap', 'vim-asterisk', 'vim-commentary', 'whitespace.nvim', 'alpha-nvim', 'nvim-web-devicons', 'unicode.vim', 'vim-highlighturl', 'vim-indent-object', 'indent-blankline.nvim', 'hop.nvim', 'vim-matchup', 'AutoSave.nvim', 'vim-repeat', 'which-key.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
