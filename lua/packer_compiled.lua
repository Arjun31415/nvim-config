...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tabnine", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-path", "copilot-cmp" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'kommentary', 'alpha-nvim', 'lualine.nvim', 'auto-save.nvim', 'bufferline.nvim', 'neoscroll.nvim', 'targets.vim', 'nvim-dap', 'vim-swap', 'vim-asterisk', 'vim-hexokinase', 'unicode.vim', 'vim-indent-object', 'open-browser.vim', 'vim-highlighturl', 'vim-matchup', 'which-key.nvim', 'whitespace.nvim', 'vim-repeat', 'vim-sandwich'}, { event = "VimEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-signify', 'hlargs.nvim', 'vimtex', 'instant.nvim', 'trouble.nvim', 'blamer.nvim', 'cmp-buffer', 'nvim-autopairs', 'cmp-tabnine', 'cmp-cmdline', 'nvim-notify', 'nvim-ts-rainbow', 'vim-kitty', 'cmp-nvim-lsp', 'cmp-path', 'presence.nvim', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
