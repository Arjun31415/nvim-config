...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-path", "cmp-tabnine", "cmp-nvim-lsp", "copilot-cmp" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'kommentary', 'vim-asterisk', 'vim-hexokinase', 'vim-highlighturl', 'lualine.nvim', 'vim-matchup', 'neoscroll.nvim', 'vim-repeat', 'vim-swap', 'bufferline.nvim', 'which-key.nvim', 'whitespace.nvim', 'vim-indent-object', 'alpha-nvim', 'auto-save.nvim', 'targets.vim', 'nvim-dap', 'hop.nvim', 'vim-sandwich', 'indent-blankline.nvim', 'open-browser.vim', 'unicode.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-kitty', 'nvim-autopairs', 'vim-signify', 'blamer.nvim', 'cmp-buffer', 'vimtex', 'cmp-cmdline', 'nvim-ts-rainbow', 'cmp-path', 'cmp-tabnine', 'cmp-nvim-lsp', 'presence.nvim', 'hlargs.nvim', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'nvim-notify', 'trouble.nvim', 'instant.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.vim', 'ultisnips', 'copilot.lua'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
