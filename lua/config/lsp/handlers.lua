...
local function lsp_keymaps(bufnr)
  ...
  vim.keymap.set("n", "<space>fb", function() vim.lsp.buf.format({ async = true }) end, opts)
end

M.on_attach = function(client, bufnr)
  -- vim.pretty_print(client.server_capabilities)
  if client.name == "tsserver" then client.server_capabilities.documentHighlightProvider = false end
  lsp_keymaps(bufnr)
